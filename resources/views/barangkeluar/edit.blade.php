...
<body>
    ...
    <div id="page-wrapper">
        <div class="container-fluid">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Edit Data Barang Keluar</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
                                    ...
                                    <div class="panel-body">
                                        ...
                                        @enderror
                                            ...
                                            <div class="panel-body">
                                                ...
                                                <input type="number" name="jumlah" value="{{$barangkeluar->stok}}" class="form-control @error('jumlah') is-invalid @enderror">
                                                @error('jumlah')
                                                    <span class="invalid-feedback" role="alert">
                                                        <strong>{{ $message }}</strong>
                                                    </span>
